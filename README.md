I made this compilable with visualstudio 14 and later, it causes an error because `snprintf` shouldn't be defined anymore (see https://stackoverflow.com/a/27754829)
